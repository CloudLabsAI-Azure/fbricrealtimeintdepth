...
6.  From the menu ribbon, select **Publish**.
    ...
    ![A screenshot of a chat AI-generated content may be incorrect.](./media/image38.png)
...
10. Return to the **Explore** pane, click **Back,** and then select
    **Save** from the menu ribbon to apply your changes.
    ...
    ![A screenshot of a chat AI-generated content may be incorrect.](./media/image75.png)
