Use case 01: Digital Twin Builder for Contoso Energy: Contextualizing
Data and Visualizing Insights
...
1.  On Fabric Home page, click on the **Account manager** on the right
    side. In the Account manager blade, navigate and select **Start
    trial** as shown in the below image.
...
4.  Open your Account manager again. Notice that you now have a heading
    for Trial status. Your Account manager keeps track of the number of
    days remaining in your trial. You will also see the countdown in
...
, StopCode = toint(10000 + abs(((toint(BusLine) \* 100) +
toint(StationNumber)) % 750))
...
7.  Select the cell, replace the code, and click the **Run** icon
    KustoCopy.

// Create table

.create table bus_data_processed (ActualTime:datetime, TripId:string,
BusLine:string, StationNumber:string, ScheduleTime:datetime,
BusState:string, TimeToNextStation:string, StopCode:int)

![](./media/image68.png)

8.  Select the cell, replace the code, and click the **Run** icon
    KustoCopy.
...
9.  Select the cell, replace the code, and click the **Run** icon

KustoCopy

// Enable OneLake availability

.alter-merge table bus_data_processed policy mirroring
...
10. Go the items view of the database again, select **Tutorial** .

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image72.png)

3.  A new table is created in your database
...
1.  Go to your **Tutorial** lakehouse from the menu ribbon. ![A
...
1.  Now, click on **Digital twin builder** on the left-sided navigation
    pane.![](./media/image81.png)

2.  Select **New item**.Search for the +++**Digital Twin Builder
    (preview**)+++ item, and select it.
...
> ![A screenshot of a data source AI-generated content may be
...
> ![Screenshot of running the bus mapping.](./media/image100.png)

12. The page confirms that the flow is queued.
...
1.  Open **Select lakehouse table** to select a data source for your
    mapping

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image126.png)

1.  In the Select data source tab, select your tutorial workspace,
...
2.  For the **Property type**, leave the default selection
    of **Non-timeseries properties**.
...
1.  Then, add the following new properties to the mapping. When you
...
> removed, and select **Apply**.
>
> ![A screenshot of a map properties AI-generated content may be
...
15. Check the status of your mapping job in the **Manage
    operations** tab. Wait for the status to say **Completed** before
    proceeding to the next task. It will take around 10-15 min to
    complete.
...
1.  In the **Relationship configuration** pane, enter the following
...
16. Wait for the status to say **Completed** before proceeding to the
    next task. It will take around 10-15 min to complete.

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image146.png)

3.  View the details of the mapping operations, and confirm that they
    all completed successfully.

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image147.png)

4.  If any of the operations failed, check the box next to its name and
...
1.  If you see a dialog box – **Shortcut creation completed**, then
    click on **Close**

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image154.png)

7.  Repeat the shortcut creation steps twice more, so that all tables
...
![Screenshot of the shortcuts available in the KQL
database.](./media/image168.png)
...
3.  Select **Upload** from the navigate to **Import** section.![A
    screenshot of a computer AI-generated content may be
...
10. On the Upload files tab, click on the folder under the Files

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image180.png)

2.  Browse to C:\LabFiles on your VM, then select
...
12. Close the **Upload files** pane and observe the new file in
...
13. In the notebook, install the package by running the first code
    block.

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image185.png)

3.  After less than a minute, the package is installed and the notebook
...
5.  In the output, a list of functions within the queryset is displayed.
    ...
    implementation and associated information![A screenshot of a
...
7.  Select the cell, replace the code with +++Bus_property()+++, and
    click the **Run** icon ![A screenshot of a computer AI-generated
    content may be incorrect.](./media/image197.png)
...
1.  Using the **+** above the query pane, create the following new
    queries. ![A screenshot of a computer AI-generated content may be
...
> //Start with the function generated by the eventhouse projection to
> get your time series bus data
>
> Bus_timeseries()
>
...
>
> | extend PercentLate = round((todouble(LateRuns) / TotalRuns \* 100),
> 2)
>
...
> | extend
>
> // inline compute delay minutes without a two‑step PredictedArrival
> alias
>
> DelayMinutes =
>
...
>
> | extend PredictedArrival = PreciseTimestamp +
> totimespan(TimeToNextStation)
>
> // Classify "will be late" as a boolean
>
> | extend WillBeLate = PredictedArrival \> todatetime(ScheduleTime) +
> 5m
>
> // Select final output columns
>
...
>
> ![Screenshot of the Estimated lateness query
> results.](./media/image216.png)
...
> ![Screenshot of exploration options in the Real-Time
> Dashboard.](./media/image232.png)
